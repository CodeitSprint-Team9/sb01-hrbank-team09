...
public interface ChangeLogRepository extends JpaRepository<ChangeLog, Long> {
	...
	@Query("""
		...
		ORDER BY c.at ASC
		""")
	List<ChangeLog> findChangeLogsAsc(String employeeNumber, String memo, String ipAddress, String type,
		Instant atFrom, Instant atTo, Long idAfter, String sortField);
	...
	@Query("""
		...
		ORDER BY c.at DESC
		""")
	List<ChangeLog> findChangeLogsDesc(String employeeNumber, String memo, String ipAddress, String type,
		Instant atFrom, Instant atTo, Long idAfter, String sortField);
