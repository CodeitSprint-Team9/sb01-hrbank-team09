...
public interface EmployeeApi {
  ...
  ResponseEntity<CursorPageResponseEmployeeDto> findEmployeeList(String nameOrEmail,
      String departmentName, String position, EmployeeStatus status,
  ...
  ResponseEntity<List<EmployeeTrendDto>> getEmployeeTrend(LocalDate from, LocalDate to,
      String unit);

  @Operation(summary = "직원 분포 조회", description = "부서별 또는 상태별 직원 분포를 조회합니다.")
  ResponseEntity<List<EmployeeDistributionDto>> getEmployeeDistributaion(String groupBy,
      String status);
